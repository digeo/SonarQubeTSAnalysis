...
def get_repos():
    ...
    #repos.append(GitHubProject(206362,'apache','commons-collections','Java',sonarqube_ip='129.125.5.41'))
    ...
    #repos.append(GitHubProject(206387,'apache','activemq','Java',sonarqube_ip='176.9.137.234'))
    ...
    #repos.append(GitHubProject(206402,'apache','httpclient','Java',sonarqube_ip='176.9.137.234'))It is analyzed now
    ...
    repos.append(GitHubProject(939852,'apache','commons-validator','Java',sonarqube_ip='145.97.155.98'))
    ...
    repos.append(GitHubProject(6290993,'apache','crunch','Java',sonarqube_ip='145.97.155.98'))
    #repos.append(GitHubProject(7728562,'apache','oodt','Java',sonarqube_ip='176.9.137.234'))
    #repos.append(GitHubProject(9290699,'apache','tez','Java',sonarqube_ip='176.9.137.234'))
    #repos.append(GitHubProject(11543457,'apache','falcon','Java',sonarqube_ip='RUG'))
    repos.append(GitHubProject(10230369,'google','auto','Java',sonarqube_ip='145.97.155.98'))
    repos.append(GitHubProject(10637893,'apache','commons-csv','Java',sonarqube_ip='145.97.155.98'))
    #repos.append(GitHubProject(11543457,'apache','falcon','Java',sonarqube_ip='129.125.5.41'))
